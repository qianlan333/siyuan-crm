...
CONFIG_CATEGORIES: tuple[ConfigCategory, ...] = (
    ...
    ConfigCategory(
        ...
        fields=(
            ...
            field("IDENTITY_INTERNAL_API_TOKEN", block_title="内部令牌"),
            field("ARCHIVE_INTERNAL_API_TOKEN", block_title="内部令牌"),
            field("GROUP_BROADCAST_INTERNAL_API_TOKEN", block_title="内部令牌"),
            field("CALLBACK_INTERNAL_API_TOKEN", block_title="内部令牌"),
