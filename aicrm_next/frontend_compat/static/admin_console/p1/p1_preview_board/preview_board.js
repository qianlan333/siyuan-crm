...
import { applyReadonlyReorderPreview, renderInteractionShell, serializeDraftPreviewForDisplay } from "../shared/interaction_shell.js";
import { renderStatusCard } from "../shared/status_card.js";
import { canRenderGlobalPass } from "../shared/status_model.js";
import { P1_PREVIEW_BOARD_FIXTURE } from "./preview_board_fixture.js";
export function buildPreviewBoardModel(payload = P1_PREVIEW_BOARD_FIXTURE.payload) {
...
export function renderP1PreviewBoard(fixture = P1_PREVIEW_BOARD_FIXTURE) {
