...
user_ops_pool_current_next = Table(
    ...
    Column("external_userid", String(128), nullable=True),
    ...
    Column("is_mobile_bound", Boolean, nullable=False, default=False),
    Column("auto_do_not_disturb_reasons_json", JSON, nullable=False, default=list),
    Column("created_at", DateTime(timezone=True), nullable=False),
    Column("updated_at", DateTime(timezone=True), nullable=False),
    Index("ix_user_ops_pool_current_next_external_userid", "external_userid"),
    Index("ix_user_ops_pool_current_next_mobile", "mobile"),
...
user_ops_do_not_disturb_next = Table(
    ...
    Column("created_at", DateTime(timezone=True), nullable=False),
    Column("updated_at", DateTime(timezone=True), nullable=False),
    Index("ix_user_ops_dnd_next_external_userid", "external_userid"),
    Index("ix_user_ops_dnd_next_mobile", "mobile"),
