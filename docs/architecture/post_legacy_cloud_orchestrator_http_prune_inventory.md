...
| --- | --- | --- | --- | --- | --- |
| `wecom_ability_service/http/cloud_orchestrator_endpoint.py` | legacy route aggregator for Cloud pages, plans, campaigns, segments, media | `aicrm_next.cloud_orchestrator.api`, `aicrm_next.post_legacy_deferred.api` | Removed from `wecom_ability_service/http/__init__.py`; no runtime import remains. | `deleted` | `tests/test_http_registration_contract.py`, `tests/test_post_legacy_cloud_orchestrator_legacy_handlers_removed.py` |
