...
from wecom_ability_service.domains.questionnaire import replay_questionnaire_sidebar_profile_mappings


def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Dry-run or replay questionnaire answers into sidebar profile fields.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        with app.app_context():
            init_db()
            payload = replay_questionnaire_sidebar_profile_mappings(
