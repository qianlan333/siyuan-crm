...
API_CONTRACT_CASES: tuple[ApiCase, ...] = (
    ...
    ApiCase("cloud_audit_read", "GET", "/api/admin/cloud-orchestrator/audit", "aicrm_next.cloud_orchestrator", (200,)),
    ApiCase("cloud_observability_read", "GET", "/api/admin/cloud-orchestrator/observability", "aicrm_next.cloud_orchestrator", (200,)),
    ApiCase(
    ...
    ApiCase("class_user_management_export", "GET", "/api/admin/class-user-management/export", "aicrm_next.class_user_management", (200,)),
    ApiCase("wecom_customer_acquisition_links_read", "GET", "/api/admin/wecom-customer-acquisition-links", "aicrm_next.automation_engine.channels_api", (200,)),
    ApiCase(
