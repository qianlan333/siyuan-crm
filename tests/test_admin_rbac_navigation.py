...
def test_new_admin_routes_map_to_specific_rbac_modules_before_admin_fallback():
    ...
    assert _module_for_admin_path("/admin/attachment-library") == "attachment_library"
    ...
    assert _module_for_admin_api_path("/api/admin/attachment-library/upload") == "attachment_library"
